...
def test_calculate_countries_above_mean_count(tmp_path):
    # A directory to create the output CSV file
    tmp_output_path = tmp_path / 'test_above_mean_count.csv'

    # Call the function with the mock DataFrame and the temporary output path
    result_df = calculate_countries_above_mean_count(df, output_csv_filename=str(tmp_output_path))
